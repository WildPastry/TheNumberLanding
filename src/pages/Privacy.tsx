...
const Privacy: React.FC = (): JSX.Element => {
  return (
    <section aria-labelledby='privacy-title' className='max-w-4xl m-auto'>
      ...
      <hr aria-hidden='true' className='h-px my-10 bg-strawberry border-0' />
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>DATA COLLECTION</h2>
        <p className='text-md'>
      ...
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>DATA USAGE</h2>
        <p className='text-md'>
      ...
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>DATA SHARING</h2>
        <p className='text-md'>
      ...
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>CHANGES</h2>
        <p className='text-md'>
      ...
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>CONTACT US</h2>
      ...
      <div className='mb-10'>
        <h2 className='text-3xl text-(--fg) mb-2'>AGREEMENT</h2>
        <p className='text-md'>
